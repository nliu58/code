...
Notes:
    ...
    (2) WWW: https://github.com/EnSpec/HyTools-sandbox/blob/master/hytools/file_io/envi_read.py
    (3) WWW: https://github.com/EnSpec/HyTools-sandbox/blob/master/hytools/file_io/envi_write.py
"""
